...
description: Competitive intelligence engine for prospect-vs-competitor analysis covering current vendors, switching costs, gaps, and positioning angles. Use when user mentions competitive analysis, competitor research, what tools/vendors a prospect uses, switching costs, alternative solutions, or asks who competes for a deal. Triggers on "Wettbewerb", "Konkurrenz", "konkurriert mit", "competitor analysis", "alternatives", "Wettbewerbsanalyse".
---
...
```
/ki-vertriebsteam:sales-competitors <url>
```
