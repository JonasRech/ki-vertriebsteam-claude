---
name: sales-followup
description: Multi-touch follow-up email sequences for warm leads, post-meeting cadences, and stalled-deal re-engagement. Use when user mentions follow-up, follow up sequence, post-meeting cadence, re-engagement of stalled prospects, or nurture-after-meeting flow. Triggers on "Follow-up", "Nachfassen", "nachhaken", "post meeting", "Reaktivierung", "warme Leads", "Nurture-Sequenz".
---
...
```
/ki-vertriebsteam:sales-followup <prospect>
```
