---
name: sales-report
description: Pipeline report in Markdown summarizing all prospect analyses in current directory — score distribution, top accounts, action plan. Use when user mentions pipeline overview, sales report, deal status summary, account portfolio status, prospect aggregate view, weekly/monthly review. Triggers on "Pipeline Report", "Vertriebsbericht", "Pipeline-Übersicht", "Deals zusammenfassen", "Sales-Report", "Pipeline-Status".
---
...
- **Invocation:** `/ki-vertriebsteam:sales-report`
...
When the user invokes `/ki-vertriebsteam:sales-report`, follow this process:
...
1. **Analyze a prospect:** Run `/ki-vertriebsteam:sales-prospect <company-website-url>` to analyze a potential customer
2. **Build your ICP first (recommended):** Run `/ki-vertriebsteam:sales-icp <description>` to define your ideal customer profile
3. **Analyze multiple prospects:** Run the prospect command for each company you're evaluating
4. **Generate this report:** Run `/ki-vertriebsteam:sales-report` again after analyzing at least one prospect

### Example Workflow

```
/ki-vertriebsteam:sales-icp "We sell an API monitoring platform for $500-2000/mo to mid-market SaaS companies"
/ki-vertriebsteam:sales-prospect https://company1.com
/ki-vertriebsteam:sales-prospect https://company2.com
/ki-vertriebsteam:sales-prospect https://company3.com
/ki-vertriebsteam:sales-report
```
```
...
Provide guidance:
- Which prospects need outreach sequences created (suggest running `/ki-vertriebsteam:sales-prospect <url>` if missing)
...
*Report generated by AI Sales Team | Refresh by running `/ki-vertriebsteam:sales-report`*
```
