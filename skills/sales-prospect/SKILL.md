---
name: sales-prospect
description: Full prospect analysis orchestrator launching 5 parallel research subagents and aggregating results into scored PROSPECT-ANALYSIS.md. Use when user mentions prospect analysis, deep-dive on a lead, full account research, qualified lead workup, comprehensive prospect audit, or wants the complete picture of a target account. Triggers on "Prospect Analyse", "Lead-Tiefenanalyse", "Account Research", "vollständige Analyse", "deep dive Prospect", "Volltiefen-Analyse".
---
...
You are the full prospect audit engine for `/ki-vertriebsteam:sales-prospect <url>`. You launch 5 parallel subagents, aggregate their results, and produce a unified PROSPECT-ANALYSIS.md report that is ready-to-use and deal-focused.

## When This Skill Is Invoked

The user runs `/ki-vertriebsteam:sales-prospect <url>`. This is the flagship command of the entire suite. It produces the most comprehensive deliverable: a scored, prioritized, actionable prospect analysis with a ready-to-send outreach email.
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/analyze_prospect.py" --url <url> --output json
```
...
*Generated by AI Sales Team — `/ki-vertriebsteam:sales-prospect`*
```
...
- Suggest follow-up commands: `/ki-vertriebsteam:sales-outreach` for full email sequence, `/ki-vertriebsteam:sales-prep` for meeting preparation, `/ki-vertriebsteam:sales-proposal` for deal-specific proposal
